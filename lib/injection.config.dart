...
import 'features/agenda/presentation/cubit/agenda_cubit.dart' as _i28;
...
import 'features/faq/presentation/cubit/faq_cubit.dart' as _i29;
import 'features/speaker/cubit/speaker_cubit.dart' as _i25;
...
import 'features/sponsor/presentation/cubit/sponsor_cubit.dart' as _i26;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i25.SpeakerCubit>(
      () => _i25.SpeakerCubit(get<_i21.GetAgendaUseCase>()));
  gh.factory<_i26.SponsorCubit>(
      () => _i26.SponsorCubit(get<_i23.GetSponsorsUseCase>()));
  gh.factory<_i27.TeamCubit>(
      () => _i27.TeamCubit(get<_i24.GetTeamMembersUseCase>()));
  gh.factory<_i28.AgendaCubit>(
      () => _i28.AgendaCubit(get<_i21.GetAgendaUseCase>()));
  gh.factory<_i29.FAQCubit>(() => _i29.FAQCubit(get<_i22.GetFAQUseCase>()));
  return get;
}
